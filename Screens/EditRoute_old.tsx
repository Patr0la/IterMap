	...
	addMarker(pos: IPos, id?: string, name?: string) {
		...
		this.onMarkerUpdate([
			...this.state.markers,
			{
				...
				types: [],
				day: this.state.markers.reduce((pv, { day }) => Math.max(pv, day), 0),
			},
		]);
	}
				...
				{this.state.editing == "route" ? (
					...
					<View style={{ width: "100%", height: "100%", flexDirection: "column" }}>
						...
						<View style={{ width: "100%", zIndex: this.state.fullscreen ? 0 : 10 }}>
							<EditMap markers={this.state.markers} ref={(ref) => (this.editMap = ref)} addMarker={(pos, id, name) => this.addMarker(pos, id, name)} data={this.props.data}></EditMap>
						</View>
