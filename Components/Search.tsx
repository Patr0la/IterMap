...
interface Props extends IProps {
    ...
    onSelectCallback: (selection: { name: string; value: any }) => void;
...
export class Search extends React.Component<Props, State> {
    ...
    querry(querry: string) {
        ...
        fetch(`http://${config.host}/${this.props.endpoint}`, {
            ...
            body: JSON.stringify({ querry, ...(this.props.requestPrepeareCallback ? this.props.requestPrepeareCallback() : {}) }),
        })
            .then(res => res.json())
            .then(resoults => {
    ...
    render() {
        return (
            <View style={{ backgroundColor: "#242424", paddingTop: "2.5%" }}>
